...
topic-to-post: a form-based AI tool that turns a topic + goal into a week's worth of ready-to-post social media content, with a built-in paid tier from day one.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238494272+jljbusinessofficial@users.noreply.github.com"
  git config user.name "jljbusinessofficial"
  ```
